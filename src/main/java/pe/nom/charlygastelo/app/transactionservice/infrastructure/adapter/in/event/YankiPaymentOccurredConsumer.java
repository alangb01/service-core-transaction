...
import pe.nom.charlygastelo.app.shared.avro.dto.YankiPaymentOccurredEvent;
import pe.nom.charlygastelo.app.transactionservice.application.usecase.TransactionProgressUseCase;

@Component
@RequiredArgsConstructor
@Slf4j
public class YankiPaymentOccurredConsumer {

    private final TransactionProgressUseCase progressUseCase;

    @KafkaListener(topics = "${topic.yanki-payment-occurred}", groupId = "transaction-service")
    public void consume(YankiPaymentOccurredEvent event) {
