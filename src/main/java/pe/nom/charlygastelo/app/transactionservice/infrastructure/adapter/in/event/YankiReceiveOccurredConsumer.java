...
import pe.nom.charlygastelo.app.shared.avro.dto.YankiReceiveOccurredEvent;
import pe.nom.charlygastelo.app.transactionservice.application.usecase.TransactionProgressUseCase;

@Component
@RequiredArgsConstructor
@Slf4j
public class YankiReceiveOccurredConsumer {

    private final TransactionProgressUseCase progressUseCase;

    @KafkaListener(topics = "${topic.yanki-receive-occurred}", groupId = "transaction-service")
    public void consume(YankiReceiveOccurredEvent event) {
